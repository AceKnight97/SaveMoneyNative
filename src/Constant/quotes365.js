...
const My365Quotes = [
  ...
  'To improve what shows up in the exterior of your world, first, be still and improve the interior. ',
  ...
  "Beating yourself up doesn't benefit anyone. Focus on what you choose to create instead.",
  ...
  'Even the largest of fires starts from a tiny spark. That same potential is within you, so set your dreams on fire!',
  ...
  'You are an unlimited being filled with infinite possibility--with the power to be, do or create anything that you desire in your life.',
  ...
  "We make the greatest difference in the world when we find a cause that's bigger than our fears and step forward with faith.",
  ...
  "If you've hit a wall or the door has closed, keep looking until you find the window, for there's always a solution.",
  ...
  "The only way to bring something into your life is to first believe that it's possible, for without vision and belief, nothing happens.",
  'No matter the question, love is always the answer. Start there first and watch magic unfold.',
  ...
  "What we choose to do in each moment defines where we're going in our life.",
  ...
  'Limitations are nothing more than artificial boundaries that we create to feel safe. Remember, you can do anything!',
  ...
  'It is your attitude that will determine your altitude in life. Confidence and optimism will take you to the top of the mountain.',
  "We have a finite amount of time, so the more we worry, the less time we have to dream. For me, I think I'd rather dream.",
  ...
  "It's easy to show kindness and love others when you first love yourself.",
  'Live your life with no regrets. Bless the past and let it go.',
  'Sometimes we forget who we are. Remember--you are an infinite being with unlimited possibility. ',
  ...
  'Believing that you lack abundance is like a fish believing that it lacks water. You are abundance. ',
  ...
  "Change happens first in our mind, then in our world. Believe it and then you'll see it.",
  ...
  'Rather than seeking gratification, which is fleeting, create lasting fulfillment instead.',
